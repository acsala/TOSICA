...
def train(adata, gmt_path, pre_weights='', label_name='Celltype',max_g=300,max_gs=300,mask_ratio =0.015, n_unannotated = 1,batch_size=8, embed_dim=48,depth=2,num_heads=4,lr=0.001, epochs= 10, lrf=0.01, train_weights_path = ""):
    r"""
    ...
    fit_model(adata, gmt_path, pre_weights=pre_weights, label_name=label_name,
              ...
              embed_dim=embed_dim,depth=depth,num_heads=num_heads,lr=lr, epochs= epochs, lrf=lrf, train_weights = train_weights_path)
